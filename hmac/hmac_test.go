...
func TestMD5(t *testing.T) {
	...
	for input, expect := range cases {
		sum, err := MD5([]byte(key), []byte(input))
		if err != nil {
			t.Fatal(err)
		}
...
func TestSHA1(t *testing.T) {
	...
	key := "key"
	for input, expect := range cases {
		sum, err := SHA1([]byte(key), []byte(input))
		if err != nil {
			t.Fatal(err)
		}
...
func TestSHA224(t *testing.T) {
	...
	key := "key"
	for input, expect := range cases {
		sum, err := SHA224([]byte(key), []byte(input))
		if err != nil {
			t.Fatal(err)
		}
...
func TestSHA256(t *testing.T) {
	...
	key := "key"
	for input, expect := range cases {
		sum, err := SHA256([]byte(key), []byte(input))
		if err != nil {
			t.Fatal(err)
		}
...
func TestSHA384(t *testing.T) {
	...
	key := "key"
	for input, expect := range cases {
		sum, err := SHA384([]byte(key), []byte(input))
		if err != nil {
			t.Fatal(err)
		}
...
func TestSHA512(t *testing.T) {
	...
	key := "key"
	for input, expect := range cases {
		sum, err := SHA512([]byte(key), []byte(input))
		if err != nil {
			t.Fatal(err)
		}
